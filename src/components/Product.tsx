    ...
    <Link href={`items/${product.id}`}>
      <article className='grid grid-cols-[45%,1fr] gap-6 p-2'>
        <picture className="grid place-content-center">
          <img loading="lazy" width={'120px'} height={'120px'} className='object-cover object-center aspect-square border border-slate-200 rounded-full shadow-md' src={product.thumbnail} alt={product.title} />
        </picture>
